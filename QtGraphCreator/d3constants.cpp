...
const QString D3Constants::scaleBand = "scaleBand()";
...
std::string D3Constants::genericCSVDataLoop = "d3.csv(%1%, function(data) {\n" \
                                            "\tconsole.log(data);\n" \
...
std::string D3Constants::setRectAttributes = "rects.attr(\"x\", function(d) { return x(d.%1%); })\n" \
                                              ...
                                              ".attr(\"height\", function(d) { return canvasHeight - y(d.%3%); })\n" \
