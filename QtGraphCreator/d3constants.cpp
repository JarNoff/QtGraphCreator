...
std::string D3Constants::canvasWidth = "var canvasWidth = %1%;";
std::string D3Constants::canvasHeight = "var canvasHeight = %1%;";
...
std::string D3Constants::xScaling = "var x = d3.%1%.range([0,canvasWidth]).padding(0.1);"; //Needs to be modified for sure
std::string D3Constants::yScaling = "var y = d3.%1%.range([canvasHeight, 0]);"; //Also needs to be modified for sure

std::string D3Constants::genericCSVDataLoop = "d3.csv(%1%).then(function(data) {/n" \
                                            "\tconsole.log(data);\n" \
